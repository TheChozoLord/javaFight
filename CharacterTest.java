...
public class CharacterTest {
    public static void main(String[] args) {
        ...
        System.out.println("\nWarrior: "+warrior.getName() + " Health: " + warrior.getHP());  // Expected: 90


        mage.setHealth(85);
        System.out.println("\nMage: "+mage.getName() + " Health: " + mage.getHP());  // Expected: 85


        archer.setHealth(-10);  // Invalid health value
        System.out.println("\nArcher: "+archer.getName() + " Health: " + archer.getHP());  // Expected: 0 (no negative health)
        archer.defend();
    }
}
